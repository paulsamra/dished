...
extern NSString *const kExploreAllURL;
extern NSString *const kAuthRefreshURL;
...
extern NSString *const kUsersDeactivateURL;
...
extern NSString *const kUserDeviceTokenURL;
...
extern NSString *const kHashtagsKey;
