...
NSString *const kExploreAllURL              = @"explore/all";
NSString *const kAuthRefreshURL             = @"auth/refresh";
...
NSString *const kAuthPasswordURL            = @"auth/password";
...
NSString *const kUsersDeactivateURL         = @"users/deactivate";
...
NSString *const kUserContactsRegisteredURL  = @"users/contacts/registered";
...
NSString *const kContactsKey     = @"contacts";
...
NSString *const kUsernameExistsError  = @"username_exists";
NSString *const kInvalidUsernameError = @"username_invalid";
